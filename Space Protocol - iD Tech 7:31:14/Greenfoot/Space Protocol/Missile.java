...
public class Missile extends Actor  
{
   ...
   int myHealth;
   boolean gone;
   public Missile(int dir) {
       setRotation(dir);
       //setDirection(direction);
   } 
   public void act()  
   {
       Actor EnemySpaceship1 = (Actor)getWorld().getObjects(EnemySpaceship1.class).get(0);
       turnTowards(EnemySpaceship1.getX(),EnemySpaceship1.getY());
       move(5);
       killEnemies();
       if (gone == false)
       {
