...
/**
 * Write a description of class MissileBad here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class MissileBad extends Actor  
{
   ...
   int myHealth;
   boolean gone;
   public MissileBad(int dir) {
       setRotation(dir);
       //setDirection(direction);
   } 
   public void act()  
   {
       Actor SpaceshipCorrect1 = (Actor)getWorld().getObjects(SpaceshipCorrect1.class).get(0);
       turnTowards(SpaceshipCorrect1.getX(),SpaceshipCorrect1.getY());
       move(5);
       killEnemies();
       if (gone == false)
       {
   ...
   public void killEnemies()
    {
        ...
        if (SpaceshipCorrect1 != null)
        {
            ...
            posX = this.getX();
            posY = this.getY();
            Background.myHealth = Background.myHealth - 2;
